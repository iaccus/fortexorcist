...
if FW.CLASS == "DRUID" then
    ...
    FW:SetCustomName(106951,FWL.BERSERK_FERAL);

    FW:SetCustomName(16979,FWL.FERAL_CHARGE);
    FW:SetCustomName(49376,FWL.FERAL_CHARGE);

    FW:SetCustomName(33917,FWL.MANGLE);

    FW:SetCustomName(106839,FWL.SKULL_BASH);
    FW:SetCustomName(106785,FWL.SWIPE);
    ...
    if ST then
        ...
        ST:AddChannel(740, 0, 2); -- Tranquility
        ...
        :AddSpell(102359, 20,"Crowd",   F.UNIQUE) -- Mass Entanglement
        ...
        :AddSpell(205636,  15,"Pet",    F.SUMMON) -- Force of Nature
        -- :AddSpell( 5570,  12,"Default",  F.TICKS):SetTickSpeed(2) -- Insect Swarm
        :AddSpell( 8921,  16,"Default", F.TICKS):SetTickSpeed(2):SetSpellModSetB("Thunderheart Regalia",2,3) -- Moonfire
        :AddSpell(93402,  12,"Default", F.TICKS):SetTickSpeed(2) -- Sunfire
        :AddSpell(202347, 24,"Default", F.TICKS):SetTickSpeed(2) -- Stellar Flare
        ...
        :AddSpell(155777, 12,"Heal",    F.HOT) -- Rejuvenation (Germination)
        :AddSpell(200390,  6,"Heal",    F.HOT) -- Cultivation
        :AddSpell(207386,  6,"Heal",    F.HOT) -- Spring Blossoms
        :AddSpell(102793, 10,"Default", F.AOE) -- Ursol's Vortex
        ...
        -- Guardian Spells
        :AddSpell(    99, 3,"Crowd",    F.UNIQUE) -- Incapacitating Roar
