...
local function NewButton(parent)
	...
	local text = obj:CreateFontString(nil, "OVERLAY")
	text:SetPoint("LEFT", obj, "LEFT")
	text:SetPoint("RIGHT", obj, "RIGHT")	
...
local function NewTextureButton(parent,n)
	...
	obj:SetScript("OnEnter",function(self)
		...
		local name = string.match(self.val, ".+\\(.+)"):gsub(".tga", ""):gsub(".blp", ""):gsub(".TGA", ""):gsub(".BLP", "")
...
local function NewTextureOption(parent,o,s,d)
	...
	if not texturedropdown then
		texturedropdown = NewDropdown(OptionsPanel,function()
			...
			for i, texture in ipairs(FW.TextureList) do
				...
				s:Show();
				local name = string.match(texture, ".+\\(.+)"):gsub(".tga", ""):gsub(".blp", ""):gsub(".TGA", ""):gsub(".BLP", "")
				s.text:SetText(name)
				j=j+1;
			end
	...
	obj.button:SetScript("OnShow",function(self)
		local name = string.match(obj.s[obj.o], ".+\\(.+)"):gsub(".tga", ""):gsub(".blp", ""):gsub(".TGA", ""):gsub(".BLP", "")
		self.text:SetText(name)				
...
function FW:LocalizedData()
	...
	:SetMainCategory(FWL.ABOUT,FW.ICON.HINT,100,"DEFAULT")
		...
		:SetSubCategory("ForteXorcist on the Web",FW.ICON.HINT,1)
			...
			:AddOption("URL","Portal","HowToPriest","http://howtopriest.com/viewtopic.php?f=26&t=3177&start=160")
			:AddOption("INF","")
			:AddOption("INF","You can update this addon there")
			:AddOption("URL","Site","Download at","http://www.aleaaddons.ru/p/fortexorcist.html")
		...
		--	:AddOption("URL","Curse","Download at Curse","http://wow.curse.com/downloads/wow-addons/details/fortexorcist.aspx")
			...
			:AddOption("URL","PayPal","Donate using PayPal","http://www.aleaaddons.ru/p/support.html")
