...
do
	...
	if not ALEAADDONS_CHATHOOKS_LISTVER or ( ALEAADDONS_CHATHOOKS_LISTVER and ALEAADDONS_CHATHOOKS_LISTVER < listversion ) then
		ALEAADDONS_CHATHOOKS_LISTVER = listversion
		ALEAADDONS_CHATHOOKS_LIST = highlighy_player
	end
	
	if ALEAADDONS_CHATHOOKS then return end
	ALEAADDONS_CHATHOOKS = true
